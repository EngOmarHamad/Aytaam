...
var KTChartsWidget13 = (function () {
    ...
    var initChart = function () {
        ...
        var init = function () {
            ...
            createSeries("Bicycles", "bicycles", KTUtil.getCssVariableValue('--bs-success'));
    ...
    var initChart = function () {
        ...
        var init = function () {
            ...
            series.data.setAll([
                ...
                { value: 5, category: "Four", fill: am5.color(KTUtil.getCssVariableValue('--bs-success')) },
            ...
            template: function (item) {
                ...
                return `<div class="rounded-pill bg-light-${item.color} d-flex align-items-center position-relative h-40px w-100 p-2 overflow-hidden">
                    ...
                    <div class="d-flex align-items-center position-relative z-index-2">
                        ...
                        <a  class="fw-bold text-white text-hover-dark">${item.content}</a>
                    </div>
