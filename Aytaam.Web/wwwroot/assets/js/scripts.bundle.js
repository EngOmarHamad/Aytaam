...
var KTApp = (function () {
    ...
    var initCollapsedCard = function () {
        $(".CollapseCardButton").click(function () {
            // Toggle the card-body visibility
            $(this).closest(".CollapsedCard").find(".card-collapese-body").slideToggle("fast");
        });

        $(".HideCardButton").click(function (e) {
            Swal.fire({
                text: "هل أنت متأكد من إزالتها ؟",
                icon: "warning",
                ...
                if (result.isConfirmed) {
                    $(e.target).closest(".CollapsedCard").slideToggle("fast");
                }
            });
            // Toggle the card-body visibility
        });
...
var KTThemeModeOrphan = (function () {
...
KTUtil.onDOMContentLoaded(function () {
    KTThemeModeOrphan.init();
});

// Declare KTThemeModeOrphan for Webpack support
if (typeof module !== "undefined" && typeof module.exports !== "undefined") {
    module.exports = KTThemeModeOrphan;
}
("use strict");
