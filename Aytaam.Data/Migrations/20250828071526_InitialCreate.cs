        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeathCertificatePath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NumberOfSiblings = table.Column<int>(type: "int", nullable: true),
                    TotalFamilyMembers = table.Column<int>(type: "int", nullable: true),
                    GuardianCertificatePath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TblOrphans", x => x.Code);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TblUploadedFiles", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OrphanCode = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TblSponsorships", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TblSponsorships_TblOrphans_OrphanCode",
                        column: x => x.OrphanCode,
